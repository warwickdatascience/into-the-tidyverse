...
3. You want to create a line plot showing how mobile phone usage has changed over time in the seven main geographic regions. Which of the following tables is this easiest to do with?
...
4. Which of the above forms is best if you just wish to view the raw data?
